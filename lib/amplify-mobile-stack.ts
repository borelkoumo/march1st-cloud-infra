...
export default class AmplifyMobileStack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    ...
    const role = new iam.Role(this, "PasswordlessAmplifyRole", {
    ...
    const app = new amplify.App(this, "PasswordlessMobile", {
      sourceCodeProvider: new amplify.GitHubSourceCodeProvider({
        owner: "borelkoumo",
        repository: "passwordless-mobile",
      ...
      autoBranchCreation: {
        ...
        patterns: ["main", "prod", "test/*"],
      },
      autoBranchDeletion: true,
    });
    app.applyRemovalPolicy(cdk.RemovalPolicy.DESTROY);
    ...
    const domain = app.addDomain("march1st-beta.com", {
      enableAutoSubdomain: true, // in case subdomains should be auto registered for branches
      autoSubdomainCreationPatterns: ["main", "prod", "test/*"], // regex for branches that should auto register subdomains
      subDomains: [
        {
          branch: mainBranch,
